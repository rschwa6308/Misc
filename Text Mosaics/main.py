...
def build_mosaic(image, source_text, size):
    ...
    aspect_ratio_correction = 0.50      # font dependent
...
if __name__ == "__main__":
    image_filename = "russell_lisa.png"
    test_image = Image.open(image_filename)
    text = " ".join(choice(["russell", "lisa", "mom", "son", "ohana", "<3", "love"]) for _ in range(1000))
    ...
    mosaic = build_mosaic(test_image, text, 400)
    print(mosaic)
